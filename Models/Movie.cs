...
namespace practice
{
    ...
    {
        public List<WatchabilityItem> items { get; set; }
    }
    public class Video
    {
        public string url { get; set; }
    ...
    public class Videos
    {
        ...
        public List<Video> teasers { get; set; }
    }
    ...
    public class Votes
{
    ...
    public double await { get; set; } // Может быть double, если это числовое значение
}
    ...
    public class Fees
    {
        public Money world { get; set; }
        public Money russia { get; set; }
        public Money usa { get; set; }
    }
